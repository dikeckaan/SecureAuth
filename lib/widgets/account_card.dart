...
class _AccountCardState extends State<AccountCard>
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      // clipBehavior ensures the bottom progress bar is clipped to rounded corners
      ...
      child: InkWell(
        ...
        child: Column(
          children: [
            ...
            // ── Thin progress bar pinned to the card bottom ────────────
            LinearProgressIndicator(
              value: _progress,
              minHeight: 3,
              backgroundColor: Colors.transparent,
              valueColor:
                  AlwaysStoppedAnimation<Color>(_timerColor.withAlpha(140)),
            ),
          ],
        ),
      ),
